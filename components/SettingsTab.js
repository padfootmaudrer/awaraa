...
export function SettingsTab(props) {
  ...
  const onSettingsOptionChosen = () => {
    props.item.onSettingsOptionChosen(props.item.key)
  }

  return (
    <View style={styles.container}>
      <TouchableOpacity activeOpacity={0.6} style={styles.settingTabContainer} onPress={onSettingsOptionChosen}>
